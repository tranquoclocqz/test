...
if (isAjaxRequest()) {
	if(isset($_POST["page"])){
		...
		$paging->k = $id = (int)$_POST['id'];
		$paging->text_sql = "SELECT ten_$lang as ten,tenkhongdau,id,photo,giaban,loainha, huong, dien_tich, diachi, ten_lien_lac, dia_chi_lien_lac, dien_thoai_lien_lac, email_lien_lac, ngaytao FROM table_product as product WHERE type like 'bat-dong-san' and id_list = '". $id ."' and noibat = 1 and hienthi = 1 ORDER BY product.id DESC";
