...
<div class="table-responsive">
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        <td></td>
        <td class="tb_data_small"><a href="#" class="tipS" style="margin: 5px;">Thứ tự</a></td>     <?php if ($config_images): ?>
            <td>
     ...
     <tr>
      ...
      <td align="center">
        ...
        <?php if ($config_images): ?>
            <td style="width: 80px">
              <div>
                <a href="index.php?com=product&act=edit_cat&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold">
                  <img src="<?php echo _upload_product.$items[$i]['photo'] ?>" alt="" class="img-responsive img-center">
                </a>
              </div>
            </td>
          <?php endif ?>
